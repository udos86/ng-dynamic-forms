...
import { DynamicFormSemanticComponent, DYNAMIC_FORM_UI_SEMANTIC } from "./dynamic-form-semantic.component";

xdescribe("DynamicFormSemanticComponent test suite", () => {

    let inputModel = new DynamicInputModel({id: "test"}),
        formModel = [inputModel],
        formGroup: FormGroup,
        fixture: ComponentFixture<DynamicFormSemanticComponent>,
        component: DynamicFormSemanticComponent,
    ...
    beforeEach(async(() => {
        ...
        TestBed.configureTestingModule({
            ...
            fixture = TestBed.createComponent(DynamicFormSemanticComponent as Type<DynamicFormSemanticComponent>);
    ...
    it("should initialize correctly", () => {
        ...
        expect(component.type).toEqual(DYNAMIC_FORM_UI_SEMANTIC);
