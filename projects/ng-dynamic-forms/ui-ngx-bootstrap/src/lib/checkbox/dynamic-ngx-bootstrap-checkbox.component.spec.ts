...
describe("DynamicNgxBootstrapCheckboxComponent test suite", () => {
    ...
    let testModel = new DynamicCheckboxModel({id: "checkbox"}),
        formModel = [testModel],
        formGroup: FormGroup,
        fixture: ComponentFixture<DynamicNGxBootstrapCheckboxComponent>,
        component: DynamicNGxBootstrapCheckboxComponent,
    ...
    beforeEach(waitForAsync(() => {
        ...
        TestBed.configureTestingModule({
            ...
            declarations: [DynamicNGxBootstrapCheckboxComponent]
