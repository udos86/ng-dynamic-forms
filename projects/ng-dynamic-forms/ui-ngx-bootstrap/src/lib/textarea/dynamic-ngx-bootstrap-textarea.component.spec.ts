...
describe("DynamicNGxBootstrapTextAreaComponent test suite", () => {
    ...
    let testModel = new DynamicTextAreaModel({id: "textarea"}),
        formModel = [testModel],
        formGroup: FormGroup,
        fixture: ComponentFixture<DynamicNGxBootstrapTextAreaComponent>,
        component: DynamicNGxBootstrapTextAreaComponent,
    ...
    beforeEach(async(() => {
        ...
        TestBed.configureTestingModule({
            ...
            declarations: [DynamicNGxBootstrapTextAreaComponent]
