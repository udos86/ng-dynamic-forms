...
describe("DynamicNGxBootstrapTimePickerComponent test suite", () => {
    ...
    let testModel = new DynamicTimePickerModel({id: "timepicker"}),
        formModel = [testModel],
        formGroup: FormGroup,
        fixture: ComponentFixture<DynamicNGxBootstrapTimePickerComponent>,
        component: DynamicNGxBootstrapTimePickerComponent,
    ...
    beforeEach(async(() => {
        ...
        TestBed.configureTestingModule({
            ...
            declarations: [DynamicNGxBootstrapTimePickerComponent]
