...
describe("DynamicFormService test suite", () => {
  let testModel: DynamicFormModel, service: DynamicFormService;
  ...
  beforeEach(inject(
    [DynamicFormService],
    (formService: DynamicFormService) => (service = formService)
  ));
  ...
  it("should parse dynamic form JSON", () => {
    ...
    expect(
      (formModel[10] as DynamicDateControlModel).value instanceof Date
    ).toBe(true);
  ...
  it("should throw when unknown DynamicFormControlModel id is specified in JSON", () => {
    expect(() => service.fromJSON([{ id: "test" }])).toThrow(
      new Error(
        `unknown form control model type defined on JSON object with id "test"`
      )
    );
  });
  ...
  it("should find a dynamic form control model by id", () => {
    expect(
      service.findById("testCheckbox", testModel) instanceof
        DynamicFormControlModel
    ).toBe(true);
    expect(
      service.findById("testCheckboxGroup", testModel) instanceof
        DynamicFormControlModel
    ).toBe(true);
    expect(
      service.findById("testDatepicker", testModel) instanceof
        DynamicFormControlModel
    ).toBe(true);
    expect(
      service.findById("testFormArray", testModel) instanceof
        DynamicFormControlModel
    ).toBe(true);
    expect(
      service.findById("testInput", testModel) instanceof
        DynamicFormControlModel
    ).toBe(true);
    expect(
      service.findById("testRadioGroup", testModel) instanceof
        DynamicFormControlModel
    ).toBe(true);
    expect(
      service.findById("testSelect", testModel) instanceof
        DynamicFormControlModel
    ).toBe(true);
    expect(
      service.findById("testSlider", testModel) instanceof
        DynamicFormControlModel
    ).toBe(true);
    expect(
      service.findById("testSwitch", testModel) instanceof
        DynamicFormControlModel
    ).toBe(true);
    expect(
      service.findById("testTextArea", testModel) instanceof
        DynamicFormControlModel
    ).toBe(true);
    expect(
      service.findById("testFileUpload", testModel) instanceof
        DynamicFormControlModel
    ).toBe(true);
    expect(
      service.findById("testEditor", testModel) instanceof DynamicEditorModel
    ).toBe(true);
    expect(
      service.findById("testTimePicker", testModel) instanceof
    ...
    expect(
      service.findById("testColorPicker", testModel) instanceof
  ...
  it("should find a dynamic form control model by path", () => {
    expect(
      service.findByPath("testCheckbox", testModel) instanceof
        DynamicFormControlModel
    ).toBe(true);
    expect(
      service.findByPath("testCheckboxGroup", testModel) instanceof
        DynamicFormControlModel
    ).toBe(true);
    expect(
      service.findByPath("testDatepicker", testModel) instanceof
        DynamicFormControlModel
    ).toBe(true);
    expect(
      service.findByPath("testFormArray", testModel) instanceof
        DynamicFormControlModel
    ).toBe(true);
    expect(
      service.findByPath("testInput", testModel) instanceof
        DynamicFormControlModel
    ).toBe(true);
    expect(
      service.findByPath("testRadioGroup", testModel) instanceof
        DynamicFormControlModel
    ).toBe(true);
    expect(
      service.findByPath("testSelect", testModel) instanceof
        DynamicFormControlModel
    ).toBe(true);
    expect(
      service.findByPath("testSlider", testModel) instanceof
        DynamicFormControlModel
    ).toBe(true);
    expect(
      service.findByPath("testSwitch", testModel) instanceof
        DynamicFormControlModel
    ).toBe(true);
    expect(
      service.findByPath("testTextArea", testModel) instanceof
        DynamicFormControlModel
    ).toBe(true);
    expect(
      service.findByPath("testFileUpload", testModel) instanceof
        DynamicFormControlModel
    ).toBe(true);
    expect(
      service.findByPath("testEditor", testModel) instanceof DynamicEditorModel
    ).toBe(true);
    expect(
      service.findById("testTimePicker", testModel) instanceof
        DynamicTimePickerModel
    ...
    expect(
      service.findByPath("testColorPicker", testModel) instanceof
        DynamicColorPickerModel
    ).toBe(true);
    expect(
      service.findByPath("testFormGroup.nestedTestInput", testModel) instanceof
        DynamicInputModel
    ).toBe(true);
    expect(
      service.findByPath(
        "testFormGroup.nestedTestTextArea",
        testModel
      ) instanceof DynamicTextAreaModel
    ).toBe(true);
    expect(
      service.findByPath(
        "testFormArray.0.testFormArrayGroupInput",
        testModel
      ) instanceof DynamicInputModel
    ).toBe(true);
    expect(
      service.findByPath(
        "testFormArray.1.testFormArrayGroupInput",
        testModel
      ) instanceof DynamicInputModel
    ).toBe(true);
    expect(
      service.findByPath(
        "testFormArray.0.testNestedFormArray.0.testNestedFormArrayGroupInput",
        testModel
      ) instanceof DynamicInputModel
    ).toBe(true);
    expect(
      service.findByPath(
        "testFormArray.1.testNestedFormArray.1.testNestedFormArrayGroupInput",
        testModel
      ) instanceof DynamicInputModel
    ).toBe(true);
  });
  ...
  it("should find a nested dynamic form control model by id", () => {
    expect(
      service.findById("testCheckboxGroup1", testModel) instanceof
        DynamicFormControlModel
    ).toBe(true);
    expect(
      service.findById("testCheckboxGroup2", testModel) instanceof
        DynamicFormControlModel
    ).toBe(true);
    expect(
      service.findById("nestedTestInput", testModel) instanceof
        DynamicFormControlModel
    ).toBe(true);
  });
  ...
  it("should resolve array group path", () => {
    ...
    expect(service.getPath(nestedModel)).toEqual([
      "testFormArray",
      "0",
      "testNestedFormArray",
      "0",
  ...
  it("should add a form control to an existing form group", () => {
    ...
    service.addFormGroupControl(
      nestedFormGroup,
      nestedFormGroupModel,
      newModel2
    );
    ...
    expect(
      (formGroup.controls["testFormGroup"] as FormGroup).controls[newModel2.id]
    ).toBeTruthy();
    expect(
      nestedFormGroupModel.get(nestedFormGroupModel.group.length - 1) ===
        newModel2
    ).toBe(true);
  });
  ...
  it("should insert a form control to an existing form group", () => {
    ...
    service.insertFormGroupControl(
      0,
      nestedFormGroup,
      nestedFormGroupModel,
      newModel2
    ...
    expect(service.getPath(nestedFormGroupModel.get(0))).toEqual([
      "testFormGroup",
      "newInput2",
    ]);
  });
  ...
  it("should move an existing form control to a different group position", () => {
    ...
    expect(
      (formGroup.controls["testFormGroup"] as FormGroup).controls[model2.id]
    ).toBeTruthy();
  ...
  it("should remove a form control from an existing form group", () => {
    ...
    service.removeFormGroupControl(
      index,
      nestedFormGroup,
      nestedFormGroupModel
    );
  ...
  it("should move up a form array group", () => {
    ...
    (formArray.at(index) as FormGroup).controls[
      "testFormArrayGroupInput"
    ].setValue("next test value 1");
    (formArray.at(index + step) as FormGroup).controls[
      "testFormArrayGroupInput"
    ].setValue("next test value 2");

    (model.get(index).get(0) as DynamicFormValueControlModel<any>).value =
      "next test value 1";
    (model.get(index + step).get(0) as DynamicFormValueControlModel<
      any
    >).value = "next test value 2";
    ...
    expect(
      (formArray.at(index) as FormGroup).controls["testFormArrayGroupInput"]
        .value
    ).toEqual("next test value 2");
    expect(
      (formArray.at(index + step) as FormGroup).controls[
        "testFormArrayGroupInput"
      ].value
    ).toEqual("next test value 1");

    expect(
      (model.get(index).get(0) as DynamicFormValueControlModel<any>).value
    ).toEqual("next test value 2");
    expect(
      (model.get(index + step).get(0) as DynamicFormValueControlModel<any>)
        .value
    ).toEqual("next test value 1");
  });
  ...
  it("should throw when form array group is to be moved out of bounds", () => {
    ...
    expect(() => service.moveFormArrayGroup(2, -5, formArray, model)).toThrow(
      new Error(
