...
describe("DynamicFormBasicComponent test suite", function () {
    ...
    beforeEach(testing_1.async(function () {
        testing_1.TestBed.configureTestingModule({
            ...
            declarations: [dynamic_form_basic_component_1.DynamicFormBasicComponent]
        });
        testing_1.TestBed.compileComponents();
    }));
    beforeEach(testing_1.inject([core_1.DynamicFormService], function (service) {
        formGroup = service.createFormGroup(formModel);
        fixture = testing_1.TestBed.createComponent(dynamic_form_basic_component_1.DynamicFormBasicComponent);
    ...
    it("tests if component initializes correctly", function () {
        expect(component.type).toEqual(dynamic_form_basic_component_1.DYNAMIC_FORM_UI_BASIC);
...
//# sourceMappingURL=dynamic-form-basic.component.spec.js.map
