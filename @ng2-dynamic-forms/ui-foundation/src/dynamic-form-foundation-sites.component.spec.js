...
describe("DynamicFormFoundationSitesComponent test suite", function () {
    ...
    beforeEach(testing_1.async(function () {
        testing_1.TestBed.configureTestingModule({
            ...
            declarations: [dynamic_form_foundation_sites_component_1.DynamicFormFoundationSitesComponent]
        });
        testing_1.TestBed.compileComponents();
    }));
    beforeEach(testing_1.inject([core_1.DynamicFormService], function (service) {
        formGroup = service.createFormGroup(formModel);
        fixture = testing_1.TestBed.createComponent(dynamic_form_foundation_sites_component_1.DynamicFormFoundationSitesComponent);
    ...
    it("tests if component initializes correctly", function () {
        expect(component.type).toEqual(dynamic_form_foundation_sites_component_1.DYNAMIC_FORM_UI_FOUNDATION_SITES);
...
//# sourceMappingURL=dynamic-form-foundation-sites.component.spec.js.map
